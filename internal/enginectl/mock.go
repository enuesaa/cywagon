...
func (m *MockEngineInterface) Close() error {
	m.ctrl.T.Helper()
...
func (mr *MockEngineInterfaceMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockEngineInterface)(nil).Close))
}
